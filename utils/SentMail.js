    ...
    const mailOptions = {
      ...
      <html>
          ...
          <img src="logo.png" alt="Logo" class="logo">
              <div class="welcome">Welcome to xxxxxx</div>
              <div class="message">Your Account has been activated now</div>
              <div>You’re all set, now you can easily handle your investments through your dashboard by just login</div>
          </body>
      </html>
  `,
      isHTML: true,
